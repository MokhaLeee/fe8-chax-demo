...
void ChapterIntroFE6_Bg3Scroll_Loop(ProcPtr proc);
...
void ChapterIntroFE6_KeyListen_Init(struct Proc * proc);
void ChapterIntroFE6_KeyListen_Loop(struct Proc * proc);
...
void ChapterIntroFE6_Init(struct Proc * proc);
void ChapterIntroFE6_BeginFadeIn(struct Proc * proc);
void ChapterIntroFE6_LoopFadeIn(struct Proc * proc);
void ChapterIntroFE6_BeginMotifFadeIn(struct Proc * proc);
void ChapterIntroFE6_LoopMotifFadeIn(struct Proc * proc);
void ChapterIntroFE6_BeginHOpenText(struct Proc * proc);
void ChapterIntroFE6_LoopHOpenText(struct Proc * proc);
void ChapterIntroFE6_BeginVOpenText(struct Proc * proc);
void ChapterIntroFE6_LoopVOpenText(struct Proc * proc);
void ChapterIntroFE6_Begin_0801E1A0(struct Proc * proc);
void ChapterIntroFE6_Loop_0801E1F8(struct Proc * proc);
void ChapterIntroFE6_Begin_0801E220(struct Proc * proc);
void ChapterIntroFE6_Loop_0801E244(struct Proc * proc);
void ChapterIntroFE6_0801E2B0(struct Proc * proc);
// void ChapterIntro_InitMapDisplay(struct Proc * proc);
// void ChapterIntro_BeginFadeToMap(struct Proc * proc);
// void ChapterIntro_LoopFadeToMap(struct Proc * proc);
void ChapterIntroFE6_BeginCloseText(struct Proc * proc);
void ChapterIntroFE6_LoopCloseText(struct Proc * proc);
void ChapterIntroFE6_BeginFastCloseText(struct Proc * proc);
void ChapterIntroFE6_LoopFastCloseText(struct Proc * proc);
void ChapterIntroFE6_BeginFadeOut(struct Proc * proc);
void ChapterIntroFE6_LoopFadeOut(struct Proc * proc);
// void ChapterIntro_BeginFastFadeToMap(struct Proc * proc);
// void ChapterIntro_LoopFastFadeToMap(struct Proc * proc);
void ChapterIntroFE6_SetSkipTarget(short arg, struct Proc * proc);
